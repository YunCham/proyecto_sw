...
export default function Page() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-indigo-600 to-purple-700">
      <div className="m-auto flex w-full max-w-4xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        {/* Left side - illustration */}
        <div className="hidden w-1/2 bg-gradient-to-br from-indigo-50 to-purple-100 p-12 lg:block">
          <div className="flex h-full flex-col items-center justify-center">
            ...
            <h2 className="mt-8 text-center text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
              Diseña. Prototipa. Colabora.
            </h2>
            <p className="mt-2 text-center text-gray-600">
              Crea impresionantes prototipos web y móviles con nuestra intuitiva plataforma de diseño
            </p>
          </div>
        </div>
        ...
        <div className="w-full p-8 sm:p-12 lg:w-1/2">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Bienvenido de nuevo</h1>
            <p className="mt-2 text-gray-600">Inicia sesión para continuar diseñando</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link className="font-medium text-indigo-600 hover:text-indigo-500 transition-colors" href="/signup">
              Regístrate gratis
            </Link>
          </p>
        </div>
